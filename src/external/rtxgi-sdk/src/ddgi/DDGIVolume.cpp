...
namespace rtxgi
{
    ...
    ERTXGIStatus DDGIVolume::SetOrigin(float3 origin)
    {
        m_desc.origin = origin;
        m_origin = m_desc.origin;
    ...
    ERTXGIStatus DDGIVolume::Update(ID3D12Resource* constantBuffer, UINT64 offsetInBytes)
    {
        ...
        //m_rotationTransform.r0 = { 1, 0, 0, 0.f };
        //m_rotationTransform.r1 = { 0, 1, 0, 0.f };
        //m_rotationTransform.r2 = { 0, 0, 1, 0.f };
        //m_rotationTransform.r3 = { 0.f, 0.f, 0.f, 1.f };
    ...
    ERTXGIStatus DDGIVolume::UpdateProbes(ID3D12GraphicsCommandList4* cmdList)
    {
        ...
        cmdList->SetComputeRootDescriptorTable(2, volumeDescriptorTableGPUHandle);
