...
#define VER_FILEDESCRIPTION_STR     "SL.INTERPOSER MODULE - " DISTRIBUTION_INFO
#define VER_INTERNALNAME_STR        "SL.INTERPOSER"
#define VER_LEGALCOPYRIGHT_STR      "Copyright 2022-2023 NVIDIA CORP"
