...
#define VER_FILEDESCRIPTION_STR     "SL.DLSS_RR PLUGIN - " DISTRIBUTION_INFO
#define VER_INTERNALNAME_STR        "SL.DLSS_RR"
#define VER_LEGALCOPYRIGHT_STR      "Copyright 2023 NVIDIA CORP"
