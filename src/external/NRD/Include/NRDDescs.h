...
namespace nrd
{
    ...
    enum class ResourceType : uint32_t
    {
        ...
        // assuming that it will be used as: translucent shadow = lerp( .yzw, 1, .x )
        ...
        IN_SVGF = IN_SPEC_HIT, // .xyz - signal1, .w - signal2
        OUT_SVGF = OUT_SPEC_HIT, // .xyz - signal1, .w - signal2
