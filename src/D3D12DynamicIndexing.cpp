...
D3D12DynamicIndexing::~D3D12DynamicIndexing()
{
...
void D3D12DynamicIndexing::LoadMesh()
{
	// Load scene assets.
	UINT fileSize = 0;
	UINT8* pAssetData;
...
void D3D12DynamicIndexing::InitComputeRS()
{
...
void D3D12DynamicIndexing::InitDrawMeshRS()
{
...
void D3D12DynamicIndexing::InitCopyPass()
{
	struct PostVertex
	{
		XMFLOAT4 position;
...
void D3D12DynamicIndexing::InitLightingPass()
{
	ComPtr<ID3DBlob> vertexShader;
	ComPtr<ID3DBlob> pixelShader;
...
void D3D12DynamicIndexing::CopyPass()
{
...
void D3D12DynamicIndexing::LightingPass()
{
...
void D3D12DynamicIndexing::DrawMeshPass()
{
...
void D3D12DynamicIndexing::RecordDraw (UINT StartIndex, UINT NumDraw, UINT CLIndex, ThreadDescriptorHeapPool* DHPool)
{
	Texture* backbuffer = ColorBuffer.get();
...
void D3D12DynamicIndexing::ComputePass()
{
...
void D3D12DynamicIndexing::InitRaytracing()
{
	// init raytracing
...
void D3D12DynamicIndexing::RaytracePass()
{
